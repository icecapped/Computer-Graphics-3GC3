...
//    // render loop
//    // -----------
//    float day = 365.0f, inc = 1.0f/24/60;
...
//        // VIEW MATRIX
//        // camera position
//        glm::vec3 cameraPos = glm::vec3(30.0f, 20.0f, 60.0f);
//        // camera targets
...
//        // PROJECTION MATRIX
//        // perspective
//        projection = glm::perspective(glm::radians(90.0f), (float)16 / (float)9, 0.1f, 1000.0f);
//        // ortho
